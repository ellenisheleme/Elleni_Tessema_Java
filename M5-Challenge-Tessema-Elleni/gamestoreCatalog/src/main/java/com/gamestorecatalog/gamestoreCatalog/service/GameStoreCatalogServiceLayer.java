package com.gamestorecatalog.gamestoreCatalog.service;
...
import com.gamestorecatalog.gamestoreCatalog.viewModel.GameViewModel;
...
public class GameStoreCatalogServiceLayer {
    ...
    public ConsoleViewModel createConsole(ConsoleViewModel consoleViewModel) {
        ...
        if (consoleViewModel == null)
            throw new IllegalArgumentException("No Console is passed! Game object is null!");
