package com.gamestoreinvoicing.gamestoreinvoicing.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.gamestoreinvoicing.gamestoreinvoicing.service.GameStoreServiceLayer;
...
public class InvoiceControllerTest {
    ...
    public void shouldAddPurchase() throws Exception{
        ...
        when(serviceLayer.createInvoice(inInvoice)).thenReturn(savedInvoice);
    ...
    public void shouldFindInvoice() throws Exception{
        ...
        //Mock call to service layer...
        when(serviceLayer.getInvoice(22)).thenReturn(savedInvoice);
        ...
        //Mock call to service layer...
        when(serviceLayer.getInvoice(-1)).thenReturn(null);
    ...
    public void shouldFindAllInvoices() throws Exception{
        ...
        //Mock call to service layer...
        when(serviceLayer.getAllInvoices()).thenReturn(foundAllInvoices);
        ...
        //Mock call to service layer...
        when(serviceLayer.getAllInvoices()).thenReturn(null);
    ...
    public void shouldFindInvoicesByCustomerName() throws Exception{
        ...
        //Mock call to service layer...
        when(serviceLayer.getInvoicesByCustomerName("Sandy Beach")).thenReturn(foundAllInvoices);
        ...
        //Mock call to service layer...
        when(serviceLayer.getInvoicesByCustomerName("no customer")).thenReturn(null);
    ...
    public void shouldFailCreateInvoiceWithBadData() throws Exception{
        ...
        when(this.serviceLayer.createInvoice(inInvoiceMV)).thenReturn(null);
