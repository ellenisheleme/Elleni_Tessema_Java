...
import com.gameStoreInvoicing.gamestoreinvoicing.model.*;
...
public class GameStoreServiceLayer {
    ...
    private GameStoreFeignClient client;
    InvoiceRepository invoiceRepo;
    TaxRepository taxRepo;
    ProcessingFeeRepository processingFeeRepo;

    @Autowired
    public GameStoreServiceLayer(GameStoreFeignClient client, InvoiceRepository invoiceRepo, TaxRepository taxRepo, ProcessingFeeRepository processingFeeRepo) {
        this.client = client;
    ...
    public InvoiceViewModel createInvoice(InvoiceViewModel invoiceViewModel) {
        ...
        if (invoiceViewModel.getItemType().equals(CONSOLE_ITEM_TYPE)) {
            ...
            Optional<ConsoleViewModel> returnVal = Optional.ofNullable(client.getConsole(invoiceViewModel.getItemId()));
            ...
            Optional<GameViewModel> returnVal = Optional.ofNullable(client.getGameInfo(invoiceViewModel.getItemId()));
            ...
            Optional<TShirtViewModel> returnVal = Optional.ofNullable(client.getTShirt(invoiceViewModel.getItemId()));
